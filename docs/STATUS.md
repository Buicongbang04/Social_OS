...
| Media: Image Generation                       | ✅  | Qua **Vertex AI** với service account — không phải AI Studio, nơi hạn mức ảnh miễn phí đã về 0. Tính tiền: ~$0.04/ảnh.                           |
| Media: Video Generation                       | ⛔  | **Dự án không hỗ trợ video** (4/8/2026). Veo và Sora tính theo giây, sinh video cục bộ trên 4 GB VRAM không thực tế, và nhu cầu thật dừng ở ảnh. |
